  ...
  return (
    ...
    >
      <div className="text-center max-w-md">
        ...
        >
          <MapPin className="w-10 h-10" style={{ color: isNigeria ? '#FFFFFF' : '#1A1A1A' }} />
        </div>
        <h1 className="text-2xl font-bold text-zinc-900 mb-3">Delivery Tracking</h1>
        <p className="text-zinc-600 mb-6">
          Real-time delivery tracking is coming soon! Track your orders with live location updates.
        </p>
        <Link
          to="/dashboard"
