  ...
  return (
    ...
    >
      <div className="text-center max-w-md">
        ...
        >
          <Send className="w-10 h-10" style={{ color: isNigeria ? '#FFFFFF' : '#1A1A1A' }} />
        </div>
        <h1 className="text-2xl font-bold text-zinc-900 mb-3">Delivery Assignments</h1>
        <p className="text-zinc-600 mb-6">
          Delivery assignment feature is coming soon! Assign deliveries to riders from here.
        </p>
        <Link
          to="/dashboard"
