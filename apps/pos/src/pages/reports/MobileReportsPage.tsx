  ...
  return (
    ...
    >
      <div className="text-center max-w-md">
        ...
        >
          <BarChart3 className="w-10 h-10" style={{ color: isNigeria ? '#FFFFFF' : '#1A1A1A' }} />
        </div>
        <h1 className="text-2xl font-bold text-zinc-900 mb-3">Mobile Reports</h1>
        <p className="text-zinc-600 mb-6">
          Mobile reports feature is coming soon! View detailed analytics on your mobile device.
        </p>
        <Link
          to="/dashboard"
