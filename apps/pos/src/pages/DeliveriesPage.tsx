  ...
  return (
    ...
    >
      <div className="text-center max-w-md">
        ...
        <h1 className="text-2xl font-bold text-zinc-900 mb-3">Delivery Management</h1>
        <p className="text-zinc-600 mb-6">
          Delivery management feature is coming soon! Track and manage deliveries from your store.
        </p>
        <Link
          to="/dashboard"
